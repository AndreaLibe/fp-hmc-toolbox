...
def main():
    ...
    average_rainfall_mm_h.to_csv(os.path.join(data_settings['data']['outcome']['folder'], 'tabs','average_rainfall_mm_h.txt'))
    average_rainfall_m3_s.to_csv(os.path.join(data_settings['data']['outcome']['folder'], 'tabs','average_rainfall_m3_s.txt'))
